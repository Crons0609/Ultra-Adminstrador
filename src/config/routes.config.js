...
// Owner Module
const getOwnerDashboardView = () => import('../modules/owner/views/dashboard.view.js').then(m => m.OwnerDashboardView);
...
export const ROUTES = [
  ...
  { path: '/waiter/client-assignments', view: lazyView(getWaiterClientAssignmentsView), middlewares: [roleGuard([USER_ROLES.WAITER, USER_ROLES.MANAGER])] },
  ...
  // Owner routes
  { path: '/owner/dashboard', view: lazyView(getOwnerDashboardView), middlewares: [roleGuard([USER_ROLES.OWNER, USER_ROLES.MANAGER])] },
  ...
  { path: '/settings/notifications', view: lazyView(() => import('../views/settings/notification-preferences.view.js').then(m => m.NotificationPreferencesView)), middlewares: [roleGuard([USER_ROLES.OWNER, USER_ROLES.MANAGER, USER_ROLES.CASHIER, USER_ROLES.WAITER, USER_ROLES.KITCHEN])] },
